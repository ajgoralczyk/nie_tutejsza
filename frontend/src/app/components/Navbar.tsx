...
export default function Navbar(props: NavbarProps) {
  ...
  return (
    <header className="p-4 xl:px-6 flex items-center bg-background sticky top-0 left-0 right-0 z-20">
      <Link
        href="/"
      ...
      <div
        className={`flex sm:hidden flex-col w-3/4 top-0 right-0 fixed p-4 gap-4 bg-background z-20 h-dvh t-0 duration-200 transform ${
